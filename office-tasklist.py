...
def add_task():
    ...
    if task:                                                    # Wenn Eingabe vorhanden
        date = input("Bis zu welchem Datum?")                   # Nutzer wird gefragt: 'Bis wann?' und die Eingabe wird in der Variablen date gespeichert
        ...
        print("Der Aufgabenliste wurde nichts hinzugefügt")                             # Gib aus: 'Nichts hinzugefügt'
add_task()
